...
import 'kleur/colors';
import 'html-escaper';
import { $ as $$Back, A as Arrow, H as Header, b as $$Footer, s as src, a as $$Layout } from './_area__yh_Ta3d4.mjs';
/* empty css                           */
...
const $$Profesional = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section data-astro-cid-wg5wzm7d> ${renderComponent($$result, "Back", $$Back, { "sectionID": `/${SECTION_ID}`, "data-astro-cid-wg5wzm7d": true })} <figure data-astro-cid-wg5wzm7d> <img${addAttribute(imagen[0], "src")}${addAttribute(`im\xE1gen de perfil del abogado ${nombre}`, "alt")} loading="lazy" data-astro-cid-wg5wzm7d${addAttribute(renderTransition($$result, "i5l6xdqf", "", `image-${nombre}`), "data-astro-transition-scope")}> </figure> <div class="content" data-astro-cid-wg5wzm7d> <header data-astro-cid-wg5wzm7d> <div class="data" data-astro-cid-wg5wzm7d> <h1 data-astro-cid-wg5wzm7d>${nombre}</h1> <h2 data-astro-cid-wg5wzm7d> <ul data-astro-cid-wg5wzm7d> ${especialidades?.map((especialidad) => {
...
<b data-astro-cid-wg5wzm7d> ${jurisdiccion[1]} </b> </span> </div> <section data-astro-cid-wg5wzm7d> <header data-astro-cid-wg5wzm7d> <h3 data-astro-cid-wg5wzm7d>Contacto</h3> </header> <ul data-astro-cid-wg5wzm7d> <li data-astro-cid-wg5wzm7d>${renderComponent($$result, "PhoneIcon", PhoneIcon, { "data-astro-cid-wg5wzm7d": true })} ${contactos.contactPhone}</li> <li data-astro-cid-wg5wzm7d> <a${addAttribute(`mailto:${contactos.email}`, "href")} data-astro-cid-wg5wzm7d> ${renderComponent($$result, "EmailIcon", EmailIcon, { "data-astro-cid-wg5wzm7d": true })} ${contactos.email}</a> </li> ${contactos.rrss?.map(({ url, username, redSocial }) => {
  ...
  })} </ul> </section> </header> <article data-astro-cid-wg5wzm7d> <section data-astro-cid-wg5wzm7d> <header data-astro-cid-wg5wzm7d> <h4 data-astro-cid-wg5wzm7d>${renderComponent($$result, "Arrow", Arrow, { "data-astro-cid-wg5wzm7d": true })} Biografía</h4> </header> <p data-astro-cid-wg5wzm7d>${biografia}</p> <div data-astro-cid-wg5wzm7d> <h4 data-astro-cid-wg5wzm7d>${renderComponent($$result, "ObjetivosIcon", ObjetivosIcon, { "data-astro-cid-wg5wzm7d": true })} Objetivos</h4> <ul class="ul-objetivos" data-astro-cid-wg5wzm7d> ${objetivos?.map((objetivo) => {
...
• ${carrera.descripcion} </li> </ul>`;
  })} </ul> </section> </article> </div> </section> `;
}, "C:/Users/ginoc/desktop/proyecto-abogados/Templates-Studios/template-01/src/components/Astro/sections/Profesional.astro", "self");
...
const $$professional = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": nombre }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", Header, { "areasLaborales": "/#Areas-laborales", "about": "/#Sobre-nosotros", "contact": "/#Contacto", "home": "/", "notices": "/#Noticias", "testimonios": "/#Testimonio", "equipo": "/#Equipo", "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/ginoc/desktop/proyecto-abogados/Templates-Studios/template-01/src/components/React/Header.jsx", "client:component-export": "default" })} ${renderComponent($$result2, "Profesional", $$Profesional, { "id": id, "posicion": posicion, "jurisdiccion": jurisdiccion, "imagen": images, "biografia": biografia, "carreras": carreras, "contactos": contact, "especialidades": especialidades, "nombre": nombre, "objetivos": objetivos, "valores": valores })} ${renderComponent($$result2, "Footer", $$Footer, { "srcMaps": src })} ` })} `;
}, "C:/Users/ginoc/desktop/proyecto-abogados/Templates-Studios/template-01/src/pages/profesionales/[professional].astro", void 0);

const $$file = "C:/Users/ginoc/desktop/proyecto-abogados/Templates-Studios/template-01/src/pages/profesionales/[professional].astro";
const $$url = "/profesionales/[professional]";

const _professional_ = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
export { EmailIcon as E, Facebook as F, LinkedIn as L, _professional_ as _, team as t };
